...
const Login = ({ onLogin }) => {
  ...
  if (showRegister) {
    return <RegistroPublico onSuccess={() => setShowRegister(false)} />;
  }
    ...
    <div className="login-container">
      <div className="login-form">
        ...
        <div className="register-link" style={{ marginTop: '1rem', textAlign: 'center' }}>
          <p>¿No tienes cuenta? <button type="button" onClick={() => setShowRegister(true)} style={{ background: 'none', border: 'none', color: '#12518c', textDecoration: 'underline', cursor: 'pointer' }}>Regístrate aquí</button></p>
        </div>
